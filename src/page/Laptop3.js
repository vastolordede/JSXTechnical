    ...
    return (
        <div className="bg-Laptop-content">
            <div className="column return-box">
                ...
                <Link className="return-text">Laptop gaming Acer Nitro V ANV16 41 R36Y</Link>
            </div>
            ...
            <div className="card-content-product">
                ...
                <div className="card-text-product">
                    <p className="title-product"><strong>Laptop gaming Acer Nitro V ANV16 41 R36Y</strong></p>
