    ...
    return (
        <div className="bg-Laptop-content">
            <div className="column return-box">
                ...
                <Link className="return-text">Laptop gaming Acer Nitro V ANV15 51 72VS</Link>
            </div>
            ...
            <div className="card-content-product">
                ...
                <div className="card-text-product">
                    <p className="title-product"><strong>Laptop gaming Acer Nitro V ANV15 51 72VS</strong></p>
