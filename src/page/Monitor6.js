    ...
    return (
        <div className="bg-Laptop-content">
            <div className="column return-box">
                ...
                <Link className="return-text"></Link>Màn hình Philips 27M2N3200S 27" IPS 180Hz chuyên game
            </div>
            ...
            <div className="card-content-product">
                <div className="card-imgcontent-product">
                    <Link to="/Monitor/Màn-hình-Philips-27M2N3200S-27-IPS-180Hz-chuyên-game"><img src={img1} className="img"></img></Link>
                </div>
                <div className="card-text-product">
                    <p className="title-product"><strong>Màn hình Philips 27M2N3200S 27" IPS 180Hz chuyên game</strong></p>
